...
import random # Importar una libreria que sirve para generar numeros "aleatorios".

adivinar = random.randrange(1, 100) # Almacenar el numero random en la variable "adivinar" y darle un rango del 1 al 100.
